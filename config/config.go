		...
		wig.MODE_NORMAL: wig.KeyMap{
			...
			"Space": wig.KeyMap{
				...
				"w": wig.KeyMap{
					...
					"4": wig.CmdWindowMoveToWorkspace_4,
					"5": wig.CmdWindowMoveToWorkspace_5,
					"6": wig.CmdWindowMoveToWorkspace_6,
					"7": wig.CmdWindowMoveToWorkspace_7,
					"8": wig.CmdWindowMoveToWorkspace_8,
					"9": wig.CmdWindowMoveToWorkspace_9,
					"0": wig.CmdWindowMoveToWorkspace_0,
				},
